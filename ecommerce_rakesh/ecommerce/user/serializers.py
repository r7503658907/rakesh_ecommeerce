...
class ProductSerializer(serializers.Serializer):
    ...
    productImage = serializers.CharField(max_length=500)
    productImage1 = serializers.CharField(max_length=500)
    productImage2 = serializers.CharField(max_length=500)
    productImage3 = serializers.CharField(max_length=500)
    productImage4 = serializers.CharField(max_length=500)
    productImage5 = serializers.CharField(max_length=500)
